...
const FRUITS = [
  {
    icon: '🍇', name: 'Schisandra Berry', origin: 'Northern China',
  ...
  {
    icon: '🌿', name: 'Soursop (Graviola)', origin: 'Amazon Rainforest',
  ...
  {
    icon: '🔴', name: 'Amla (Indian Gooseberry)', origin: 'India',
  ...
  {
    icon: '🟠', name: 'Sea Buckthorn', origin: 'Himalayas & Siberia',
  ...
  {
    icon: '🟡', name: 'Camu Camu', origin: 'Amazon Basin',
  ...
  {
    icon: '⚫', name: 'Black Elderberry', origin: 'Europe & North America',
...
const PRODUCTS = [
  {
    ...
    label: 'System 01', name: '7-Day Dopamine Reset', price: '£29.99', badge: 'Most Popular',
  ...
  },
  {
    ...
    label: 'System 02', name: 'Natural Oils Bible', price: '£27.99', badge: '50+ Oils',
  ...
  },
  {
    ...
    label: 'System 03', name: 'Natural Salts & Minerals', price: '£27.99', badge: '20+ Minerals',
  ...
  },
  {
    ...
    label: 'System 04', name: 'Sacred Fruits Bible', price: '£27.99', badge: 'New Release',
    ...
    <>
          ...
          <div className="anim-in d4" style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
            {['🔒 Secure Checkout', '⚡ Instant Download', '🌿 100% Natural', '🌍 Worldwide Access'].map(badge => (
              <div key={badge} style={{
                ...
                background: 'rgba(255,255,255,0.75)', border: '1px solid rgba(168,224,188,0.5)',
                borderRadius: 'var(--radius-pill)', padding: '8px 16px',
                backdropFilter: 'blur(12px)', fontSize: '0.82rem', fontWeight: 600, color: 'var(--forest)',
              }}>{badge}</div>
            ))}
          </div>
        </div>
      ...
      <section className="section-sm" style={{ background: 'var(--ivory)', borderBottom: '1px solid var(--border-warm)' }}>
        <div className="container">
          ...
          {/* FIXED: symmetrical pill grid */}
          <div className="problems-grid" style={{ marginBottom: '2rem' }}>
      ...
      <section id="products" className="section bg-sage-mesh" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            ...
            {PRODUCTS.map(({ id, icon, gradient, label, name, price, badge, desc, href }) => (
              <div key={id} className="product-card" style={{ position: 'relative' }}>
                ...
                <div className="product-card-body">
                  ...
                  <h3 style={{ marginBottom: '0.6rem', fontSize: 'clamp(0.95rem, 1.8vw, 1.15rem)' }}>{name}</h3>
                  <p style={{ color: 'var(--muted)', fontSize: '0.82rem', lineHeight: 1.65, marginBottom: '1.2rem' }}>{desc}</p>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.75rem' }}>
                    <span style={{ fontFamily: 'var(--font-display)', fontSize: '1.35rem', color: 'var(--forest)', fontWeight: 500 }}>{price}</span>
          ...
          {/* FIXED: Bundle card — stacks cleanly on mobile */}
          <div className="bundle-card">
            <div className="orb orb-gold" style={{ width: 300, height: 300, top: -80, right: -60 }} />
            <div className="bundle-card-left">
              <div style={{ marginBottom: '0.75rem' }}>
                <span className="tag" style={{ background: 'var(--gold)', color: 'white', fontSize: '0.62rem' }}>
                  🔥 Best Value — Save Over £50
                </span>
              </div>
              <h3 style={{ color: 'white', marginBottom: '0.5rem' }}>Complete Healvana Bundle — All 4 Guides</h3>
            ...
            <div className="bundle-card-right">
              <div style={{ textAlign: 'center' }}>
                <span style={{ display: 'block', color: 'rgba(255,255,255,0.4)', fontSize: '0.82rem', textDecoration: 'line-through', marginBottom: '2px' }}>£113.96</span>
                <span style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 5vw, 2.8rem)', color: 'white', lineHeight: 1 }}>£59.99</span>
                <span style={{ display: 'block', color: 'rgba(255,255,255,0.4)', fontSize: '0.72rem', marginTop: '2px' }}>one-time payment</span>
              </div>
              <BuyButton productId="bundle-all" label="Get Bundle →" className="btn btn-gold" style={{ padding: '14px 32px', fontSize: '0.95rem', whiteSpace: 'nowrap' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
            ...
            <div style={{
              ...
              fontSize: '0.82rem', color: 'var(--forest)', fontWeight: 600, marginBottom: '3rem',
            }}>
            ...
            {FRUITS.map(({ icon, name, origin, tease, locked }) => (
              <div key={name} className="card" style={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  borderRadius: 'var(--radius-md)', padding: '1rem', position: 'relative', overflow: 'hidden',
                }}>
                  <div style={{
                    position: 'absolute', inset: 0, backdropFilter: 'blur(5px)',
                    background: 'rgba(234,248,240,0.7)', borderRadius: 'var(--radius-md)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
